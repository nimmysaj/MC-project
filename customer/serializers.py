...
from app1.models import Category, Complaint, Country_Codes, Customer, CustomerReview, Invoice, Payment, ServiceProvider, ServiceRegister, ServiceRequest, Subcategory
